...
public class Testes3
{
	...
	public void tabuleiroFinal1()
	{
		...
		SquareBoard tabuleiro = jogo.pegarBoardWithFinalState();
		
		assertEquals(new Tile(1), tabuleiro.getTile(new Position(1, 1)));
	}
	
	@Test
	public void tabuleiroFinal()
	{
		List<Position> posições = new ArrayList<Position>();
		for (int i = 1; i <= 3; i++)
			for (int j = 1; j <= 3; j++)
